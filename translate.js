// To whoever wrote this abomination, who hurt you
...
function evenUpSizes(a, b) {
	if (a.length > b.length) while (a.length > b.length) b.push("");
	else if (b.length > a.length) while (b.length > a.length) a.push("");
}
